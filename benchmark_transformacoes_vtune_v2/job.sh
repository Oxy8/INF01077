...
if [[ -f "$submission_dir/benchmark_transformacoes_vtune_v2/run.sh" ]]; then
    ...
    printf 'Execute sbatch a partir da raiz do repositorio ou de benchmark_transformacoes_vtune_v2.\n' >&2
    exit 2
fi
